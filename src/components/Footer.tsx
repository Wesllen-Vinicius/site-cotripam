export function Footer() {
  return (
    <footer className=" h-full text-center lg:text-left bg-[#1a5970] text-white">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="">
            ...
            md:justify-start
          ">
              <img src="src/resources/images/logo-filled.svg" className="h-14" />
            </h6>
            <p className="font-bold ">
              COTRIPAM IND. E COM. DE TRIPAS
            </p>

            <p className="font-bold">
              PORTAL DO AMAZONAS LTDA
            </p>
          </div>
          <div className="">
            ...
            <div className="border-b border-gray-300 w-44"></div>
            <p className="mb-4 mt-4">
              <a href="#!" className="text-white">Salgados</a>
            </p>
            <p className="mb-4">
              <a href="#!" className="text-white">Congelados</a>
            </p>
            <p className="mb-4">
              <a href="#!" className="text-white">Naturais</a>
            </p>
          </div>
          <div className="">
          ...
          <div className="">
            ...
            <div className="border-b border-gray-300 w-44"></div>
            <p className="flex items-center  justify-center md:justify-start mb-4 mt-4">
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="home"
                className=" text-white w-4 mr-4" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                <path fill="currentColor"
                  d="M280.37 148.26L96 300.11V464a16 16 0 0 0 16 16l112.06-.29a16 16 0 0 0 15.92-16V368a16 16 0 0 1 16-16h64a16 16 0 0 1 16 16v95.64a16 16 0 0 0 16 16.05L464 480a16 16 0 0 0 16-16V300L295.67 148.26a12.19 12.19 0 0 0-15.3 0zM571.6 251.47L488 182.56V44.05a12 12 0 0 0-12-12h-56a12 12 0 0 0-12 12v72.61L318.47 43a48 48 0 0 0-61 0L4.34 251.47a12 12 0 0 0-1.6 16.9l25.5 31A12 12 0 0 0 45.15 301l235.22-193.74a12.19 12.19 0 0 1 15.3 0L530.9 301a12 12 0 0 0 16.9-1.6l25.5-31a12 12 0 0 0-1.7-16.93z">
                </path>
              </svg>
              Senador Guiomard, Rua Celso Furtado, Acre - BR
            </p>
      ...
      <div className="text-center font-bold p-1 bg-[#073647]">
        <span>© 2021 COTRIPAM - </span>
        <a className="text-white font-semibold" href="https://tailwind-elements.com/">Todos os Direitos Reservados</a>
      </div>
    </footer>
  );
}
